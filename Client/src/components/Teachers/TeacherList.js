...
//   const navigate = useNavigate();
  ...
  return (
    <div className="p-6">
      ...
      {/* <Link to="/admin/teachers/new" className="bg-blue-500 text-white p-2 rounded">Add New Teacher</Link> */}
      {teachers.length === 0 ? (
        ...
        <ul className="mt-4">
          {teachers.map((teacher) => (
            <li key={teacher._id} className="bg-white p-4 mb-4 rounded shadow">
              ...
              <Link to={`/admin/teachers/edit/${teacher.teacherId}`} className="bg-yellow-500 text-white p-2 rounded mr-2">Edit</Link>
              <Link to={`/admin/teachers/assign/${teacher.teacherId}`} className="bg-green-500 text-white p-2 rounded mr-2">Course Assign</Link>
